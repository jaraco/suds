...
_invalid_date_strings = (
    ...
    "1900-01-01-2a:00",
    "1900-01-01-222:00",
    "1900-01-01-12:000" "1900-01-01+00:60",
    "1900-01-01-00:99",
)
...
_invalid_time_strings = (
    ...
    "13:27:04+12:",
    "13:27:04+12:00:00",
    "13:27:04-:13" "13:27:04-24:00" "13:27:04+99:00",
)
...
class TestDate:
    ...
    @pytest.mark.parametrize(
        "source", (None, object(), _Dummy(), datetime.time(10, 10))
    )
...
class TestDateTime:
    ...
    def testConstructFromString(self, string, y, M, d, h, m, s, micros):
        assert DateTime(string).value == datetime.datetime(y, M, d, h, m, s, micros)
    ...
    def testConstructFromString_subsecondRounding(
        self, string, y, M, d, h, m, s, micros
    ):
    ...
    @pytest.mark.parametrize(
        ...
        (
            ("2013-11-19T14:05:23.428068-3", 2013, 11, 19, 14, 5, 23, 428068, -3, 0),
            ("2013-11-19T14:05:23.068+03", 2013, 11, 19, 14, 5, 23, 68000, 3, 0),
            (
            ...
            ("2013-11-19T14:05:23.428068+02:00", 2013, 11, 19, 14, 5, 23, 428068, 2, 0),
            (
    ...
    def testConstructFromString_timezone(
        self, string, y, M, d, h, m, s, micros, tz_h, tz_m
    ):
    ...
    @pytest.mark.parametrize(
        "source",
        (None, object(), _Dummy(), datetime.date(2010, 10, 27), datetime.time(10, 10)),
    )
    def testConstructFromUnknown(self, source):
...
class TestTime:
    ...
    def testConstructFromString_subsecondRounding(self, string, h, m, s, micros):
        assert Time(string).value == datetime.time(h, m, s, micros)
    ...
    def testConstructFromString_timezone(self, string, h, m, s, micros, tz_h, tz_m):
        tzdelta = datetime.timedelta(hours=tz_h, minutes=tz_m)
        tzinfo = FixedOffsetTimezone(tzdelta)
...
class TestXDate:
    ...
    @pytest.mark.parametrize("source", (None, object(), _Dummy(), datetime.time()))
